...
class ReviewTile extends StatelessWidget {
  const ReviewTile(
      ...
      required this.createdDate, this.onDelete})
      : super(key: key);
  ...
  factory ReviewTile.fromReviewClassWithDelete(ReviewClass review, Future Function() onDelete) {
    return ReviewTile(
      rating: review.rating,
      comment: review.comment,
      createdDate: review.createdDate,
              ...
              children: [
                ...
                PopupMenuButton(
                  ...
                  itemBuilder: (BuildContext context) => [
                    PopupMenuItem(child: Text("Delete review", style: popUpMenuItemTextStyle), onTap: () {}, value: 1,)
                  ],
                )
              ],
            ),
