                                ...
                                {refundRequests && refundRequests.map((refundRequest, i) => (
                                    <tr key={i}>
                                        ...
                                        <td className="w-2/12 whitespace-nowrap px-5 py-4 text-sm text-gray-500">
                                            <div className="text-gray-900">{refundRequest.orderItem.car.name}</div>
                                            <div className="text-gray-500">{refundRequest.orderItem.car.description}</div>
                                        </td>
                                        ...
                                        <td className="w-1/12 whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            ...
                                            { refundRequest.isRejected &&
                                                <span className="inline-flex rounded-full bg-red-100 px-2 py-1 text-xs font-semibold leading-5 text-red-800">
                                                    Rejected
                                                </span>
                                            }
                                        ...
                                        <td className="w-1/12 relative whitespace-nowrap px-3 py-4 text-center text-sm font-medium flex gap-4">
                                            {
                                                !refundRequest.isRejected && !refundRequest.isApproved && <>
                                                    <a href="#" className="text-indigo-600 hover:text-indigo-900" onClick={() => approveRefund(refundRequest.id)}>
                                                        Approve
                                                    </a>
                                                    <a href="#" className="text-red-600 hover:text-red-900" onClick={() => disapproveRefund(refundRequest.id)}>
                                                        Disapprove
                                                    </a>
                                                </>
                                            }
